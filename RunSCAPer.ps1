...
if([bool]$psISE) {
	$thisPath = Split-Path $psISE.CurrentFile.FullPath -Parent
} else {
	$thisPath = $PSScriptRoot
}

$Global:checklistFolder = Join-Path $thisPath 'Checklists'
$Global:logFolder = Join-Path $thisPath 'Logs'
$Global:moduleUpdaterFolder = Join-Path $thisPath 'ModuleUpdater'
$Global:orgSettingsFolder = Join-Path $thisPath 'OrgSettings'
$Global:sourceFolder = Join-Path $thisPath 'Source'
$Global:STIGFolder = Join-Path $thisPath 'STIGS'
